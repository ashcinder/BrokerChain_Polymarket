...
public class Web3Repository {
    ...
    private static final String CONTRACT_ADDRESS = "0x7676e056F05de50755a3b336Ea071dA830Fb49Fb";
    ...
    public static class GameModel {
        ...
        public BigInteger totalPool;      // 真金白银总池子
        ...
        // 🌟 AMM 替换为以下两个变量
        public List<BigInteger> virtualReserves; // 【AMM 核心】虚拟储备金，代表市场定价
        public List<BigInteger> myShares;        // 【AMM 核心】当前登录使用者持有的份额
    }
}